...
#define TRAVERSE_CURRENT_MA 1000    // Traverse motor RMS current (mA) - max for 24V stepper
#define TRAVERSE_MICROSTEPS 1        // 1x for traverse (full steps - maximum torque)
